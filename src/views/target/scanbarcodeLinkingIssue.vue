        ...
        <div class="container-fluid">
          <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white p-4 d-flex justify-content-between align-items-center">
              <h4 class="mb-0 fw-bold">📊 Laporan Target - Scan Barcode Issue Linking</h4>
            </div>
...
const getReport = async () => {
  loading.value = true;
  try {
    const res = await axios.get(`${API_BASE_URL}/target/linking-scanbarcode`, { params: filters.value });
