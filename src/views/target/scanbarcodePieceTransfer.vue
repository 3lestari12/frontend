      ...
      >
        <div class="container-fluid">
          <div class="card shadow-sm border-0 mb-4">
            ...
            >
              <h4 class="mb-0 fw-bold">📦 Piece Transfer (WHA2I → EXP)</h4>
            </div>
              ...
              <div class="mt-4">
                ...
                <div v-if="data.length > 0">
                  <div class="table-responsive">
                    <table id="qtyRemoveTable" class="table table-striped table-hover w-100">
...
const initializeDataTable = () => {
  nextTick(() => {
    const tableEl = document.getElementById("qtyRemoveTable");
    if (!tableEl) return;
    ...
    dataTableInstance = $(tableEl).DataTable({
      ...
      data: data.value,
      columns: [
        { data: "xDateTime", render: (d) => formatDate(d)  },
        { data: "_xPO" },
        { data: "_RDept_Name" },
        { data: "_SDept_Name" },
        { data: "_Style" },
...
const getReport = async () => {
  loading.value = true;
  try {
    const res = await axios.get(`${API_BASE_URL}/target/piece-transfer`, {
